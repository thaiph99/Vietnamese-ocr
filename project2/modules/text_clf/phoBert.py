...
class MyDataset(Dataset):
    def __init__(self, data):
        ...
        self.rdrsegmenter = VnCoreNLP(
            "weights/vncorenlp/VnCoreNLP-1.1.1.jar", annotators="wseg", max_heap_size='-Xmx500m')
...
class predict_phoBert(nn.Module):
    ...
    def forward(self, texts):
        test_gen = DataLoader(MyDataset(
            texts), batch_size=32, shuffle=False, num_workers=0, collate_fn=self.collate_fn)
